...
| **HMM regime overlay** | 3-state Gaussian HMM on trailing 3yr SPY returns. Scales gross by regime (BULL 1.00 / NEUTRAL 0.85 / BEAR 0.65). Only acts when posterior confidence > 55%. Inspired by Hamilton 1989 + MDPI 2020 regime-switching factor paper. | `REGIME_OVERLAY_ENABLED=0` | `=1` | Tail-loss reduction in confirmed bears; near-zero effect in ambiguous regimes |
