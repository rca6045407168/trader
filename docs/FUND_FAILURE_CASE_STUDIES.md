...
**Information-edge that's actually illegal.** Galleon. Applicable specifically to the FlexHaul thesis-ledger sleeve. The ledger discipline in BLINDSPOTS.md exists to keep that sleeve on the right side.
...
**Lesson 5 — visible-positioning awareness.** Melvin's lesson scaled down: even at $10k, *if* the FlexHaul thesis-ledger sleeve goes LIVE, the universe of positions becomes inferable from your LinkedIn / FlexHaul / Apollo activity. Do not publicly comment on specific public-company tickers in FlexHaul-context channels in the days surrounding any trade. This is a behavioral pre-commit, not a code change.
